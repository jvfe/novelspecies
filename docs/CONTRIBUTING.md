...
# `nf-core/novelspecies`: Contributing guidelines

Hi there!
Thanks for taking an interest in improving nf-core/novelspecies.

This page describes the recommended nf-core way to contribute to both nf-core/novelspecies and nf-core pipelines in general, including:

- [General contribution guidelines](#general-contribution-guidelines): common procedures or guides across all nf-core pipelines.
- [Pipeline-specific contribution guidelines](#pipeline-specific-contribution-guidelines): procedures or guides specific to the development conventions of nf-core/novelspecies.

> [!NOTE]
> If you need help using or modifying nf-core/novelspecies, ask on the nf-core Slack [#novelspecies](https://nfcore.slack.com/channels/novelspecies) channel ([join our Slack here](https://nf-co.re/join/slack)).
...
- [ ] Check whether a GitHub [issue](https://github.com/nf-core/novelspecies/issues) about your idea already exists. If an issue does not exist, create one so that others are aware you are working on it.
- [ ] [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [nf-core/novelspecies repository](https://github.com/nf-core/novelspecies) to your GitHub account.
...
For further information and help, see the [nf-core/novelspecies documentation](https://nf-co.re/novelspecies/usage) or ask on the nf-core [#novelspecies](https://nfcore.slack.com/channels/novelspecies) Slack channel ([join our Slack here](https://nf-co.re/join/slack)).

### GitHub Codespaces

You can contribute to nf-core/novelspecies without installing a local development environment on your machine by using [GitHub Codespaces](https://github.com/codespaces).
...
To get started, open the repository in [Codespaces](https://github.com/nf-core/novelspecies/codespaces).
...
nf-core semi-standardises how you write code and other contributions to make the nf-core/novelspecies code and processing logic more understandable for new contributors and to ensure quality.
